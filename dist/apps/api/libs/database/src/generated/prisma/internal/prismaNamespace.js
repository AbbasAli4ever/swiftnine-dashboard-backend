...
exports.ChannelMessageScalarFieldEnum = {
    id: 'id',
    channelId: 'channelId',
    senderId: 'senderId',
    kind: 'kind',
...
exports.ChannelMessageMentionScalarFieldEnum = {
    id: 'id',
    messageId: 'messageId',
    mentionedUserId: 'mentionedUserId',
    createdAt: 'createdAt'
};
exports.ChannelMessageReactionScalarFieldEnum = {
    id: 'id',
    messageId: 'messageId',
    userId: 'userId',
    emoji: 'emoji',
...
exports.ChannelJoinRequestScalarFieldEnum = {
    id: 'id',
    channelId: 'channelId',
    userId: 'userId',
    status: 'status',
