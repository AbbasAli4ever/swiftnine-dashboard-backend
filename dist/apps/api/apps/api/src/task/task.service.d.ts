...
import { Prisma, type Role } from "../../../../libs/database/src/generated/prisma/client";
...
export declare class TaskService {
    ...
    findOne(workspaceId: string, userId: string, taskId: string): Promise<TaskDetailData>;
    ...
    findSubtasks(workspaceId: string, userId: string, parentTaskId: string): Promise<TaskListItemData[]>;
    ...
    private toListItem;
    private toListItems;
    private isTaskFavorite;
    private taskFavoriteIds;
