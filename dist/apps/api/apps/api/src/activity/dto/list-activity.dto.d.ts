...
export declare const ListActivitySchema: z.ZodObject<{
    ...
    categories: z.ZodPipe<z.ZodPipe<z.ZodOptional<z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>>, z.ZodTransform<string[] | undefined, string | string[] | undefined>>, z.ZodTransform<("name" | "status" | "description" | "priority" | "comments" | "workspace" | "project" | "tag" | "list" | "tags" | "attachments" | "reorder" | "due_date" | "assignee" | "member" | "invite" | "task_creation" | "start_date" | "completion" | "time_tracked" | "list_moved" | "subtask" | "archived_deleted")[] | undefined, string[] | undefined>>;
