...
export declare class CommentsController {
    ...
    updateReaction(req: WorkspaceRequest, reactionId: string, dto: CreateReactionDto): Promise<ApiRes<runtime.Types.Result.GetResult<import("@app/database/generated/prisma/models").$ReactionPayload<ExtArgs>, T, "update", GlobalOmitOptions>>>;
